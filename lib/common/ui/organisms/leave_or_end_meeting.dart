...
class _LeaveOrEndMeetingDialogOptionState extends State<LeaveOrEndMeetingDialogOption> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Text("👋 Leave Meeting", style: TextStyle(height: 1, fontSize: 18, fontWeight: FontWeight.bold)),
      content: Container(
        child: Column(
            ...
            GestureDetector(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text('End Meeting', style: TextStyle(height: 1, fontSize: 18)),
                  SizedBox(width: 16),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Row(
                      children: [
                        Icon(forceValue ? Icons.check_box : Icons.check_box_outline_blank),
                        SizedBox(width: 4),
                        Text('Lock Room', style: TextStyle(height: 1, fontSize: 18))
                      ],
                    ),
                  ),
                ],
