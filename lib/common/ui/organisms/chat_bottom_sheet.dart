                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: TextStyle(
                                              fontSize: 10.0, color: Colors.black, fontWeight: FontWeight.w900),
                                        ),
                                      ),
                                      Expanded(
                                        child: Text(
                                          HMSMessageRecipientValues.getValueFromHMSMessageRecipientType(_meetingStore
                                              .messages[index].hmsMessageRecipient!.hmsMessageRecipientType),
                                          style: TextStyle(
                                              fontSize: 15.0, color: Colors.blue, fontWeight: FontWeight.w900),
                                        ),
                                      ),
                                      Text(
                                        _meetingStore.messages[index].time.toString(),
                                        style:
                                            TextStyle(fontSize: 10.0, color: Colors.black, fontWeight: FontWeight.w900),
                                      )
                                    ],
                                  ),
                                  SizedBox(
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            if (this.valueChoose == "Everyone") {
                              ...
                              _meetingStore.sendDirectMessage(message, this.valueChoose);
                              _meetingStore.addMessage(HMSMessage(
                                sender: _meetingStore.localPeer!,
                                message: message,
                                type: "chat",
...
void chatMessages(BuildContext context, MeetingStore meetingStore) {
  showModalBottomSheet(context: context, builder: (ctx) => ChatWidget(meetingStore), isScrollControlled: true);
}
