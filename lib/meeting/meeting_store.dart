...
abstract class MeetingStoreBase with Store implements HMSUpdateListener, HMSLogListener {
  ...
  void onUpdateSpeakers({required List<HMSSpeaker> updateSpeakers}) {
    ...
    int newHighestIndex = tracks.indexWhere((element) => element.peer?.peerId == highestAudioSpeaker.peer.peerId);
  ...
  void changeRole({required String peerId, required String roleName, bool forceChange = false}) {
    meetingController.changeRole(roleName: roleName, peerId: peerId, forceChange: forceChange);
  }
