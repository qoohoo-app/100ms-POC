...
class ParticipantOrganism extends StatefulWidget {
  ...
  const ParticipantOrganism({Key? key, required this.peer, required this.meetingStore}) : super(key: key);
...
class _ParticipantOrganismState extends State<ParticipantOrganism> {
              ...
              showDialog(
                  ...
                  builder: (_) => ChangeRoleOptionDialog(
                        ...
                        changeRole: (role, forceChange) {
                          ...
                          widget.meetingStore
                              .changeRole(peerId: peer.peerId, roleName: role.name, forceChange: forceChange);
                        },
                      ));
            },
            child: Container(
  ...
  void checkButtons() async {
    this.isAudioOn = !(await widget.meetingStore.meetingController.isAudioMute(widget.peer));
    this.isVideoOn = !(await widget.meetingStore.meetingController.isVideoMute(widget.peer));
    setState(() {});
  }
}
